...
const youtube = new YouTube("AIzaSyC8-KeHx8ZMhaOXs9zOgxiMwCCXRzE7dBs"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyC8-KeHx8ZMhaOXs9zOgxiMwCCXRzE7dBs"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@717164618434478161>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content === "السلام عليكم") {
    message.channel.send("وعليكم السلام منور/هـ <a:emoji_21:756223770594770955> <a:heart51:740574607341256705>");
...
client.on("message", message => {
  if (message.content === "باك") {
    message.channel.send("ولكم باك حياك الله بس كأنك طولت؟؟ <a:stfu:760913389513474068>"
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "برب") {
    message.channel.send("تيت لا تطول <a:emoji_21:756223770594770955>"
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "باي") {
    message.channel.send("الله معك . لا تنسانا تعال زورنا <a:644201510355337216:761990747230437426> <a:happy:740576654136574085>"
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content.split(" ")[0] === prefix + "رابط") {
    ...
    const Embed11 = new Discord.RichEmbed().setColor("RANDOM")
      .setDescription(`** مدة الرابط : يومين 
